...
nums = [*1..1000]
output_alt = nums.select do |num|
  num if (num + num.to_s.reverse.to_i) == (num + num.to_s.reverse.to_i).to_s.reverse.to_i
end
puts output_alt

if (output_alt = expected_output) && (output = expected_output)
